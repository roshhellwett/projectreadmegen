# src/projectreadmegen/constants.py
#
# Application-wide constants — language patterns, skip lists, template names, etc.
# This file contains NO runtime logic, only static data definitions.
...
# Default AI model for Groq LPU inference
